...
const TimeDistance = () => {
    ...
    const { formattedDistance, setFormattedDistance, formattedTime, setformattedTime } = useTimeDistanceContext();
    ...
    useEffect(() => {
        if (travelingRouteData) {
            ...
            const formattedDistance =
                distanceInKilometer < 1 ? roundDistanceInMeter + 'm' : roundDistanceInKilometer + 'km';
            ...
            const formattedTime = hours > 0 ? `${hours}h ${minutes}min` : minutesFormat;
